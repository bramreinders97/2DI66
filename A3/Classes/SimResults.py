...
class SimulateResults:
    ...
    def __init__(self, extension_6, nr_floors=5):
        ...
        self.cut_off = -1       # The time after which peoples data is collected (warm up time)
    ...
    def make_calculations(self, cut_off=2028):
        ...
        if self.make_calculations_executed:
            print("make_calculations already executed. This may lead to unwanted behaviour")
